...
export const toolEntries: ToolEntry[] = [
  { id: 'bio-trivia-box', title: '生物冷知识盲盒', description: '随机探索一条有趣的生物知识。', category: 'bio', path: '/tools/bio-trivia-box' },
  ...
  { id: 'cosmic-blind-box', title: '今日宇宙盲盒', description: '每日一条宇宙趣味内容入口。', category: 'astro', path: '/tools/cosmic-blind-box' },
